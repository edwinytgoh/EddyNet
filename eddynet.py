...
class EddyNet(nn.Module):
    def __init__(self, num_classes, num_filters, kernel_size):
        """
        PyTorch implementation of EddyNet ("EddyNet: A Deep Neural Network For Pixel-Wise Classification of Oceanic Eddies", from R. Lguensat et al.)
        Authors' pre-print available at: https://arxiv.org/abs/1711.03954

        Args:
            num_classes (int): number of classes (2 for binary classification, i.e., eddy vs. not eddy, 3 for not eddy, cyclonic, or anticyclonic)
